...
$select_email = "SELECT COUNT(*) as email_exist, id, name, image, role FROM users WHERE email='$email'";
...
// $select_user_result_after_assoc = mysqli_fetch_assoc($select_user_result_after_assoc);

// $_SESSION['designation'] = $select_user_result_after_assoc['designation'];
