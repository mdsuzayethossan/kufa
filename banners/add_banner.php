                    ...
                    <div class="card-body">
                        <form action="banner_post.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="">Hello Word</label>
                                <input type="text" class="form-control" name="hello" value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Banner Dot Image</label>
                                <input type="file" class="form-control" name="dot_image">
                            </div>
                            <div class="form-group">
