        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <a href="index.html" class="navbar-brand s-logo-none"><img src="uploads/logos/<?=$after_assoc_logo['logo']?>" alt="Logo"></a>
            ...
            <div class="extra-info">
                ...
                <div class="side-info mb-30">
                    ...
                    <div class="contact-list mb-30">
                        <h4>Phone Number</h4>
                        <p><a  style="color: #8b98af;" href="tel:0<?=$after_assoc_contact['phone']?>">0<?=$after_assoc_contact['phone']?></a></p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Email Address</h4>
        ...
        <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                <h6 class="wow fadeInUp" data-wow-delay="0.2s"><?=$after_assoc_banner['hello']?></h6>
                                ...
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                        <?php foreach($select_social_result as $soial) {?>
                                        <li><a href="<?=$soial['social_link']?>"><i class="<?=$soial['icon_class']?>"></i></a></li>
                                        <?php }?>
                            ...
                            <div class="education">
                                <div class="location">
                                    ...
                                    <div class="progressWrapper">
                                        <div class="progress">
                                            <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: <?= $skills['percentage']?>%;" aria-valuenow="<?= $skills['percentage']?>" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="service" class="services-area pt-120 pb-50">
				<div class="container">
					...
					<div class="row">
                        <?php foreach($select_service_result as $services) {?>
						<div class="col-lg-4 col-md-6">
							<div class="icon_box_01 wow fadeInLeft" data-wow-delay="0.2s">
                                <i class="<?=$services['logo_class']?>"></i>
								<h3><?=$services['service_name']?></h3>
								<p>
                                <?= substr($services['description'], 0, 120).'....'.'</br>'.'Read More'?>
								</p>
							</div>
						</div>
                        <?php }?>
            ...
            <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
                <div class="container">
                    ...
                    <div class="row">
                        <?php foreach($select_project_result as $projects){?>
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img src="uploads/projects/<?=$projects['image']?>" alt="img">
								</div>
								<div class="speaker-overlay">
									<span><?=$projects['category']?></span>
									<h4><a href="portfolio-single.php?id=<?=$projects['id']?>"><?=$projects['title']?></a></h4>
									<a href="portfolio-single.php?id=<?=$projects['id']?>" class="arrow-btn"><?=$projects['information']?><span></span></a>
								</div>
							</div>
                        </div>
                        <?php }?>
                            ...
                            <?php foreach($select_testimonials_result as $testimonials) {?>
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img style="border-radius: 50%; width: 90px; height: 90px;" src="uploads/testimonials/<?=$testimonials['client_photo']?>" alt="img">
                                    </div>
                                    <div class="testi-content">
                                        <h4><span><?=$testimonials['quiote']?></span> <?=$testimonials['comments']?> <span><?=$testimonials['quiote']?></span></h4>
                    ...
                    <div class="row brand-active">
                        ...
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="uploads/partners/<?=$partners['logo']?>" alt="img">
                            </div>
                        </div>
                        <?php }?>
                            ...
                            <div class="contact-content">
                                ...
                                <div class="contact-list">
                                    <ul>
                                        ...
                                        <li><i class="fas fa-headphones"></i><span>Phone :</span><a  style="color: #8b98af;" href="tel:0<?=$after_assoc_contact['phone']?>">0<?=$after_assoc_contact['phone']?></a></li>
                                        <li><i class="fas fa-globe-asia"></i><span>e-mail :</span><a style="color: #8b98af;" href="mailto:<?=$after_assoc_contact['email']?>"><?=$after_assoc_contact['email']?></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
