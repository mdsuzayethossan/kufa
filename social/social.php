                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a target="_blank"  href="social_edit.php?id=<?php echo $social['id']?>" class="btn btn-danger">Edit</a>
                            </td>
                            <td> 
                              <a id='social_soft_delete.php?id=<?php echo $social['id']?>' class="btn btn-danger delete">Delete</a>
                           </td>
                          </tr>
                          <?php }?>
                        </tbody>
