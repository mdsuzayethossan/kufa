                        ...
                        <div style="background-color: orange;" class="card-header">
                            ...
                            <form action="banner_update.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="exampleInputEmail1" class="form-label">Hello</label>
                                    <input type="text" value="<?= $after_assoc['hello']?>" name="hello" class="form-control" id="exampleInputEmail1">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Dot Image</label></br>
                                    <img width="70" src="../uploads/dot_image/<?= $after_assoc['dot_image']?>" alt="">
                                </div>
                                <div class="mb-3">
                                    <input type="file" name="dot_image" value="" class="form-control" id="exampleInputEmail1">
